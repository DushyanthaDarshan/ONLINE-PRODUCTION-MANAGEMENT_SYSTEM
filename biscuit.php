...
<?php if (isset($_SESSION['username'])) : ?>
	...
	<table align="center" width="80%" cellpadding="5" style="margin-top: 230px;">
						<tr>
							<th colspan="8" style="font-size: 45px; background-color:#a3a1ed">Green Garden Biscuits</th>
						</tr>
						...
						<?php
							$product_get_query = "SELECT * FROM products WHERE PRODUCT_TYPE='Biscuits'";
						...
						?>
							<?php $img = $rows['IMG'] ?>
				<?php switch ($img) {
						case "imgs/Biscuits/chocolate.jpg": ?>
					<tr style="background-color: #D2691E; font-size: 25px; font-family: Comic Sans MS, cursive, sans-serif">
					<td align="center"><img src="imgs/Biscuits/chocolate.jpg" alt="strawbery_jam" id="img1" width=250 height=200></td>
					<?php break ?>
					<?php case "imgs/Biscuits/ginger.jpg": ?>
					<tr style="background-color: #8B4513; font-size: 25px; font-family: Comic Sans MS, cursive, sans-serif">
					<td align="center"><img src="imgs/Biscuits/ginger.jpg" alt="mango jam" id="img2" width=250 height=200></td>
					<?php break ?>
					...
					<td align="center"><img src="imgs/Biscuits/peanut.jpg" alt="wood apple" id="img2" width=250 height=200></td>
					<?php break ?>
				<?php } ?>
