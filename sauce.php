...
<?php if (isset($_SESSION['username'])) : ?>
	...
	<table align="center" width="80%" cellpadding="5" style="margin-top: 230px;">
						<tr>
							<th colspan="8" style="font-size: 45px; background-color:#a3a1ed">Green Garden Sauce</th>
						</tr>
			...
			<th style="color: #000000; text-shadow: 2px 2px 4px #FFFFFF;">Product Image</th>
						...
						<?php
							$product_get_query = "SELECT * FROM products WHERE PRODUCT_TYPE='Sauce'";
						...
						?>
							<?php $img = $rows['IMG'] ?>
				<?php switch ($img) {
						case "imgs/Sauce/tomatoe.jpg": ?>
					<tr style="background-color: #FF6347; font-size: 25px; font-family: Comic Sans MS, cursive, sans-serif">
					<td align="center"><img src="imgs/Sauce/tomatoe.jpg" alt="strawbery_jam" id="img1" width=250 height=200></td>
					<?php break ?>
					<?php case "imgs/Sauce/chilli.jpg": ?>
					<tr style="background-color: #8B0000; font-size: 25px; font-family: Comic Sans MS, cursive, sans-serif">
					<td align="center"><img src="imgs/Sauce/chilli.jpg" alt="mango jam" id="img2" width=250 height=180></td>
					<?php break ?>
					<?php case "imgs/Sauce/garlic.jpg": ?>
					<tr style="background-color: #C0C0C0; font-size: 25px; font-family: Comic Sans MS, cursive, sans-serif">
					<td align="center"><img src="imgs/Sauce/garlic.jpg" alt="wood apple" id="img2" width=250 height=200></td>
					<?php break ?>
				<?php } ?>
