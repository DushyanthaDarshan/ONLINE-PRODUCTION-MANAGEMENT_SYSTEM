...
<?php if (isset($_SESSION['username'])) : ?>
	...
	<table align="center" width="80%" cellpadding="5" style="margin-top: 230px;">
						<tr>
							<th colspan="8" style="font-size: 45px; background-color:#a3a1ed">Green Garden Jam</th>
						</tr>
			...
			<th style="color: #000000; text-shadow: 2px 2px 4px #FFFFFF;">Product Image</th>
						...
						<?php
							$product_get_query = "SELECT * FROM products WHERE PRODUCT_TYPE='Jam'";
						...
						?>
							<?php $img = $rows['IMG'] ?>
				<?php switch ($img) {
						case "imgs/Jam/str_jam.jpg": ?>
					<tr style="background-color: #FA8072; font-size: 25px; font-family: Comic Sans MS, cursive, sans-serif">
					<td align="center"><img src="imgs/Jam/str_jam.jpg" alt="strawbery_jam" id="img1" width=250 height=200></td>
					<?php break ?>
					...
					<td align="center"><img src="imgs/Jam/mangoe_jam.jpg" alt="mango jam" id="img2" width=250 height=200></td>
					<?php break ?>
					<?php case "imgs/Jam/wood_jam.jpg": ?>
					<tr style="background-color: #A52A2A; font-size: 25px; font-family: Comic Sans MS, cursive, sans-serif">
					<td align="center"><img src="imgs/Jam/wood_jam.jpg" alt="wood apple" id="img2" width=250 height=200></td>
					<?php break ?>
				<?php } ?>
